...
作業中（対応待ちM2への既読返信M3の回収と保存済みUID参照を修正中）
...
- 追加実装Issue: #26・#27 Closed、#28〜#32 Open
...
#31 は追加調整のcommit、Actions、実機確認待ち。#28〜#30と#32もOpenのまま維持する。
...
現時点で #6〜#17・#23・#26・#27 はCloseしているが、#18〜#22・#24・#25・#28〜#32がOpenのため、
#5 は Open のまま維持されている。
